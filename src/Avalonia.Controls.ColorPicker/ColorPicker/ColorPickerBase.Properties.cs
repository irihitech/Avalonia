...
{
    /// <inheritdoc/>
    public abstract partial class ColorPickerBase
    {
        /// <summary>
        /// Defines the <see cref="Color"/> property.
        /// </summary>
        public static readonly StyledProperty<Color> ColorProperty =
            AvaloniaProperty.Register<ColorPickerBase, Color>(
                nameof(Color),
                Colors.White,
        ...
        public static readonly StyledProperty<ColorModel> ColorModelProperty =
            AvaloniaProperty.Register<ColorPickerBase, ColorModel>(
                nameof(ColorModel),
                ColorModel.Rgba);
        ...
        public static readonly StyledProperty<ColorSpectrumComponents> ColorSpectrumComponentsProperty =
            AvaloniaProperty.Register<ColorPickerBase, ColorSpectrumComponents>(
        ...
        public static readonly StyledProperty<ColorSpectrumShape> ColorSpectrumShapeProperty =
            AvaloniaProperty.Register<ColorPickerBase, ColorSpectrumShape>(
        ...
        public static readonly StyledProperty<AlphaComponentPosition> HexInputAlphaPositionProperty =
            AvaloniaProperty.Register<ColorPickerBase, AlphaComponentPosition>(
        ...
        public static readonly StyledProperty<HsvColor> HsvColorProperty =
            AvaloniaProperty.Register<ColorPickerBase, HsvColor>(
                nameof(HsvColor),
                Colors.White.ToHsv(),
                defaultBindingMode: BindingMode.TwoWay,
        ...
        public static readonly StyledProperty<bool> IsAccentColorsVisibleProperty =
            AvaloniaProperty.Register<ColorPickerBase, bool>(
        ...
        public static readonly StyledProperty<int> MaxHueProperty =
            AvaloniaProperty.Register<ColorPickerBase, int>(
                nameof(MaxHue),
                359);
        ...
        public static readonly StyledProperty<IEnumerable<Color>?> PaletteColorsProperty =
            AvaloniaProperty.Register<ColorPickerBase, IEnumerable<Color>?>(
        ...
        public static readonly StyledProperty<IColorPalette?> PaletteProperty =
            AvaloniaProperty.Register<ColorPickerBase, IColorPalette?>(
                nameof(Palette),
                null);
